    ...
    <section id="experience" className="px-5 py-24 sm:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative mt-14 pl-8 sm:pl-12">
          ...
          <div className="absolute left-0 top-8 h-4 w-4 rounded-full border-4 border-void bg-teal shadow-glow-t sm:left-2" aria-hidden="true" />

          <article
            ref={cardRef}
            className={`rounded-2xl border border-border-dim bg-card p-6 transition-all duration-700 sm:p-8 ${
